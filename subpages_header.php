...
<body class="overflow-x-hidden">
  <header>
    <!-- <div class="bg-red-100 rounded-lg py-5 px-6 mb-4 text-base text-red-700 mb-0 text-center" role="alert">
      <p>Diversity, equity and inclusion have always been the bedrock of our commitment to upholding and enhancing a just and welcoming environment; a place where rich academic experiences are equitable for all students and inclusive work settings are bountiful for all faculty and staff.<p>
    </div> -->
    <!--
    <div class="bg-red-100 rounded-lg py-5 px-6 mb-4 text-base text-red-700 mb-0 text-center" role="alert">
    ...
    <!-- <nav
      ...
      <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
        ...
        <div class="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent1">
          <a class="text-xl text-white pr-2 font-semibold mr-10" href="./index.php">Kaiser Permanente</a> -->
          <!-- Left links -->
          <!-- <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">

            <li class="nav-item p-2">
              <a class="nav-link text-white opacity-60 hover:opacity-80 focus:opacity-80 p-0" href="#">Memeber
                Information</a>
            </li>
            <li class="nav-item p-2">
              <a class="nav-link text-white opacity-60 hover:opacity-80 focus:opacity-80 p-0" href="#">COVID-19 Care</a>
            </li>
            <li class="nav-item p-2">
              <a class="nav-link text-white opacity-60 hover:opacity-80 focus:opacity-80 p-0" href="#">Contact Us</a>
            </li>
          </ul> -->
          <!-- Left links -->
        <!-- </div> -->
